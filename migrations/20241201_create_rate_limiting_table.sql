-- Migration: Create rate limiting table and function
-- This migration creates the necessary infrastructure for database-backed rate limiting
...
-- Create policy to allow service role access (adjust as needed for your security requirements)
