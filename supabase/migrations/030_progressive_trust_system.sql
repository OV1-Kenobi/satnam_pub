...
CREATE POLICY IF NOT EXISTS "users_see_own_trust_history" ON public.trust_history
...
CREATE POLICY IF NOT EXISTS "users_see_own_reputation_actions" ON public.reputation_actions
  FOR SELECT USING (user_id = auth.uid());
