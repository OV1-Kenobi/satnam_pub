...
This NIP introduces **Outcome-Scoped Credit Envelopes (OSCE)**: credit that can _only_ be used for a **specific job**, within a **hard cap**, within a **time window**, settled via Bitcoin rails, and recorded as auditable receipts and reputation signals.
