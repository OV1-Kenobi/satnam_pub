...
const EducationPlatform: React.FC<EducationPlatformProps> = ({ onBack }) => {
  const [currentView, setCurrentView] = useState<'dashboard' | 'lesson' | 'category'>('dashboard');
  ...
  const familyMembers: FamilyMember[] = [
    { id: '1', name: 'David', avatar: 'D', progress: 85, streak: 12, badges: 8 },
  ...
  const categories: LessonCategory[] = [
    {
      ...
      icon: <img src="/LN Bitcoin icon.png\" alt="Bitcoin\" className="h-8 w-8" />,
    ...
    },
    {
      ...
      icon: <img src="/Citadel Academy Logo.png\" alt="Citadel Academy\" className="h-8 w-8" />,
  ...
  const achievements = [
    { id: 'first-lesson', title: 'First Steps', description: 'Complete your first lesson', icon: <Play className="h-5 w-5" /> },
    { id: 'week-streak', title: 'Dedicated Learner', description: '7-day learning streak', icon: <Flame className="h-5 w-5" /> },
    { id: 'category-master', title: 'Category Master', description: 'Complete an entire category', icon: <Trophy className="h-5 w-5" /> },
    { id: 'family-leader', title: 'Family Leader', description: 'Highest family progress', icon: <Crown className="h-5 w-5" /> }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-purple-900 rounded-2xl p-6 mb-8 border border-yellow-400/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Bitcoin Mastery Path</h1>
                <p className="text-purple-200">Your family's journey to Bitcoin sovereignty</p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 text-center">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Learning Streak</h3>
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {categories.map((category) => (
                  ...
                  >
                    <div className="flex items-center space-x-4 mb-4">
                      <div className={`w-12 h-12 bg-gradient-to-br ${category.color} rounded-full flex items-center justify-center text-white`}>
                        {category.icon}
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-purple-200 text-sm">{category.lessons.length} lessons</span>
                      <div className="flex items-center space-x-1">
                        {category.lessons.slice(0, 3).map((lesson, index) => (
                          <div
                            key={index}
                            className={`w-3 h-3 rounded-full ${
                              lesson.completed ? 'bg-green-400' : 
                              lesson.locked ? 'bg-gray-500' : 'bg-yellow-400'
                            }`}
                          />
                        ))}
                        {category.lessons.length > 3 && (
                          <span className="text-purple-200 text-xs">+{category.lessons.length - 3}</span>
                        )}
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-r from-purple-900/80 to-blue-900/80 backdrop-blur-sm rounded-2xl p-8 border border-yellow-400/30">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">Ready for Advanced Learning?</h2>
                <p className="text-purple-100 text-lg">"Number-go-up and responsibility-go-up technology requires your knowledge to go up!"</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-purple-200 text-sm mb-3">My First Bitcoin Diploma, coding bootcamps, home mining</p>
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-purple-200 text-sm mb-3">1:1 guidance from Bitcoin experts</p>
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-purple-200 text-sm mb-3">Bitcoin books, hardware, educational materials</p>
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-purple-200 text-sm mb-3">Collaborative learning with other families</p>
              ...
              <div className="text-center">
                <p className="text-purple-100 mb-4 italic">"Sovereignty is a journey that begins at home, in YOUR castle - unlock your full potential for self-rule in the Citadel Academy"</p>
                <a
                  href="https://citadel.academy"
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  <div key={member.id} className="flex items-center space-x-3 bg-white/10 rounded-lg p-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-purple-200 text-xs">{member.progress}%</span>
                      </div>
                    </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <div className="space-y-3">
                {achievements.slice(0, 3).map((achievement) => (
                  <div key={achievement.id} className="flex items-center space-x-3 bg-white/10 rounded-lg p-3">
