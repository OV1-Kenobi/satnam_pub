        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-purple-200">
                {verifiedMembers}/{familyMembers.length} verified
              </span>
            </div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <span
                          className={`text-sm ${getStatusColor(member.nipStatus)}`}
                        >
                          {member.nipStatus === "verified"
                            ? "Verified"
                            : member.nipStatus === "pending"
                              ? "Pending"
                              : "Not Set"}
                        </span>
                  ...
                  <div className="text-right">
                    <p className="text-white font-semibold">
                      {formatSats(member.lightningBalance)}
                    </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`flex items-center space-x-2 ${getStatusColor(relayStatus)}`}
                >
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-6">
              ...
              <p className="text-purple-200 text-sm mb-3">
                Understanding Lightning Network Channels
              </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-200 text-xs">
                    Create a fresh backup with recent changes
                  </p>
                </div>
              </div>
            </div>
