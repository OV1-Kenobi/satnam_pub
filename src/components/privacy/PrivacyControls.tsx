...
interface PrivacyControlsProps {
  currentLevel: 'public' | 'family' | 'private';
  onLevelChange: (level: 'public' | 'family' | 'private') => void;
...
function getAvailablePrivacyLevels(userRole: string): PrivacyLevel[] {
  const allLevels: PrivacyLevel[] = [
    {
      id: 'public',
      label: 'Transparent',
      description: 'Show most transaction details to family members',
    ...
    },
    {
      ...
      description: 'Hide external transaction details, show family activity',
    ...
    },
    {
      ...
      description: 'Minimize all transaction visibility and use privacy routing',
        ...
        <div className="flex items-start space-x-2">
          ...
          <div>
            ...
            <p className="text-xs text-purple-700 mt-1">
              {currentLevel === 'private' && "Using maximum privacy with LN Proxy routing and Cashu ecash"}
              {currentLevel === 'family' && "Balancing family transparency with external privacy"}
              {currentLevel === 'public' && "Sharing transaction details within family circle"}
            </p>
          </div>
        </div>
      </div>
