...
const FamilyCoordination: React.FC<FamilyCoordinationProps> = ({ onBack }) => {
  const [activeTab, setActiveTab] = useState<'overview' | 'tasks' | 'meetings' | 'governance' | 'infrastructure'>('overview');
  ...
  const upcomingMeetings: FamilyMeeting[] = [
    {
      ...
      duration: 60,
      attendees: ['David', 'Sarah', 'Emma', 'Luke'],
    ...
    },
    {
      ...
      agenda: ['Long-term Goals', 'Infrastructure Upgrades', 'Education Roadmap'],
      status: 'scheduled'
    }
  ];
  ...
  const activeProposals: GovernanceProposal[] = [
    {
      ...
      description: 'Proposal to increase our family DCA from $500 to $750 per month',
      proposer: 'David',
      votes: [
        { member: 'David', vote: 'yes' },
        { member: 'Sarah', vote: 'yes' }
      ],
      status: 'active',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-purple-900 rounded-2xl p-6 mb-8 border border-yellow-400/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Advanced Family Coordination</h1>
                <p className="text-purple-200">Orchestrate your family's Bitcoin sovereignty journey</p>
              </div>
            </div>
            
            <div className="flex items-center space-x-4">
              <div className="bg-white/10 rounded-lg p-3">
                <img src="/Rebuilding_Camelot_logo__transparency_v3.png" alt="Rebuilding Camelot" className="h-8 w-8" />
              </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-2 mb-8 border border-white/20">
          <div className="flex space-x-2">
            {[
              ...
              { id: 'tasks', label: 'Tasks & Goals', icon: <Target className="h-4 w-4" /> },
              { id: 'meetings', label: 'Family Meetings', icon: <Calendar className="h-4 w-4" /> },
              { id: 'governance', label: 'Governance', icon: <Crown className="h-4 w-4" /> },
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 text-center">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Active Goals</h3>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 text-center">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Coordination Score</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  {coordinationTasks.filter(task => task.priority === 'high' || task.priority === 'critical').map((task) => (
                    <div key={task.id} className="bg-white/10 rounded-lg p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-purple-300 text-sm">Assigned to: {task.assignee}</span>
                        <span className={`text-sm font-semibold ${getStatusColor(task.status)}`}>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  {upcomingMeetings.map((meeting) => (
                    <div key={meeting.id} className="bg-white/10 rounded-lg p-4">
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-white font-semibold">{meeting.title}</h3>
                        <span className="text-purple-300 text-sm">{meeting.duration} min</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-purple-300 text-sm">{meeting.attendees.length} attendees</span>
                        </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <img src="/Citadel Academy Logo.png" alt="Citadel Academy" className="h-10 w-10" />
                  </div>
                  <h3 className="text-white font-bold text-lg mb-2">Security Posture</h3>
                  <div className="w-full bg-white/20 rounded-full h-3 mb-2">
                    <div className="bg-gradient-to-r from-orange-400 to-red-500 h-3 rounded-full" style={{ width: '92%' }} />
                  </div>
                  <p className="text-orange-400 font-semibold">92% Secure</p>
                  <p className="text-purple-200 text-sm">Multi-sig, cold storage, recovery plans</p>
                </div>

                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <img src="/LN Bitcoin icon.png" alt="Lightning Bitcoin" className="h-10 w-10" />
                  </div>
                  <h3 className="text-white font-bold text-lg mb-2">Financial Sovereignty</h3>
                  <div className="w-full bg-white/20 rounded-full h-3 mb-2">
                    <div className="bg-gradient-to-r from-yellow-400 to-orange-500 h-3 rounded-full" style={{ width: '87%' }} />
                  </div>
                  <p className="text-yellow-400 font-semibold">87% Independent</p>
                  <p className="text-purple-200 text-sm">Bitcoin allocation, Lightning setup</p>
                </div>
                ...
                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-purple-400 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <img src="/Rebuilding_Camelot_logo__transparency_v3.png" alt="Rebuilding Camelot" className="h-10 w-10" />
                  </div>
                  <h3 className="text-white font-bold text-lg mb-2">Family Coordination</h3>
                  <div className="w-full bg-white/20 rounded-full h-3 mb-2">
                    <div className="bg-gradient-to-r from-purple-400 to-blue-500 h-3 rounded-full" style={{ width: '94%' }} />
                  </div>
                  <p className="text-purple-400 font-semibold">94% Aligned</p>
                  <p className="text-purple-200 text-sm">Communication, governance, goals</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'tasks' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-white">Family Tasks & Goals</h2>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              {['pending', 'in-progress', 'completed'].map((status) => (
                <div key={status} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <h3 className="text-white font-bold text-lg mb-4 capitalize">{status.replace('-', ' ')}</h3>
                  <div className="space-y-4">
                    {coordinationTasks.filter(task => task.status === status).map((task) => (
                      <div key={task.id} className="bg-white/10 rounded-lg p-4">
                        <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-purple-300">{task.assignee}</span>
        ...
        {activeTab === 'meetings' && (
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              {upcomingMeetings.map((meeting) => (
                <div key={meeting.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-white font-bold text-xl mb-2">{meeting.title}</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <ul className="space-y-2">
                        {meeting.agenda.map((item, index) => (
                          <li key={index} className="text-purple-200 flex items-center space-x-2">
                    ...
                    <div>
                      <h4 className="text-white font-semibold mb-3">Attendees</h4>
                      <div className="flex flex-wrap gap-2">
                        {meeting.attendees.map((attendee, index) => (
                          <div key={index} className="bg-white/10 rounded-full px-3 py-1">
                            <span className="text-purple-200 text-sm">{attendee}</span>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        {activeTab === 'governance' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-white">Family Governance</h2>
              <button className="bg-purple-700 hover:bg-purple-800 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 flex items-center space-x-2">
                <Plus className="h-5 w-5" />
            ...
            <div className="space-y-6">
              {activeProposals.map((proposal) => (
                <div key={proposal.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-white font-bold text-xl mb-2">{proposal.title}</h3>
                      <p className="text-purple-200 mb-3">{proposal.description}</p>
                      <div className="flex items-center space-x-4 text-sm text-purple-300">
                        <span>Proposed by: {proposal.proposer}</span>
                        <span>Deadline: {proposal.deadline.toLocaleDateString()}</span>
                      </div>
                    </div>
                    <div className={`px-3 py-1 rounded-full text-sm font-semibold ${getStatusColor(proposal.status)}`}>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-white font-semibold mb-3">Current Votes</h4>
                      <div className="space-y-2">
                        {proposal.votes.map((vote, index) => (
                          <div key={index} className="flex items-center justify-between bg-white/10 rounded-lg p-3">
                            <span className="text-purple-200">{vote.member}</span>
                            <span className={`font-semibold ${
                              vote.vote === 'yes' ? 'text-green-400' : 
                              vote.vote === 'no' ? 'text-red-400' : 'text-yellow-400'
                            }`}>
                    ...
                    <div>
                      <h4 className="text-white font-semibold mb-3">Cast Your Vote</h4>
        ...
        {activeTab === 'infrastructure' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-white">Family Infrastructure</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-semibold">Full Node</span>
                      <div className="flex items-center space-x-2 text-green-400">
                        <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse" />
                        <span className="text-sm">Online</span>
                      </div>
                    </div>
                    <p className="text-purple-200 text-sm">Bitcoin Core v24.0.1 - Fully synced</p>
                  </div>
                  
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-semibold">Lightning Node</span>
                      <div className="flex items-center space-x-2 text-yellow-400">
                        <div className="w-3 h-3 bg-yellow-400 rounded-full animate-pulse" />
                        <span className="text-sm">Syncing</span>
                      </div>
                    </div>
                    <p className="text-purple-200 text-sm">LND v0.16.0 - 12 channels, 2.5M sats capacity</p>
                  </div>
                  
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-semibold">Hardware Wallets</span>
                      <div className="flex items-center space-x-2 text-green-400">
                        <CheckCircle className="h-4 w-4" />
                        <span className="text-sm">Secured</span>
                      </div>
                    </div>
                    <p className="text-purple-200 text-sm">3 Coldcard devices, 2-of-3 multisig</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-semibold">Nostr Relay</span>
                      <div className="flex items-center space-x-2 text-green-400">
                        <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse" />
                        <span className="text-sm">Active</span>
                      </div>
                    </div>
                    <p className="text-purple-200 text-sm">Private family relay - 4 connected clients</p>
                  </div>
                  
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-semibold">Mesh Network</span>
                      <div className="flex items-center space-x-2 text-blue-400">
                        <Wifi className="h-4 w-4" />
                        <span className="text-sm">Connected</span>
                      </div>
                    </div>
                    <p className="text-purple-200 text-sm">Local mesh for emergency communication</p>
                  </div>
                  
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-white font-semibold">Backup Systems</span>
                      <div className="flex items-center space-x-2 text-green-400">
                        <Shield className="h-4 w-4" />
                        <span className="text-sm">Protected</span>
                      </div>
                    </div>
                    <p className="text-purple-200 text-sm">Encrypted backups, multiple locations</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <h3 className="text-white font-bold text-xl mb-6">Infrastructure Management</h3>
