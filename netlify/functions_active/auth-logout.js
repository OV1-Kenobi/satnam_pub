// Netlify (active) Function: /api/auth/logout -> /.netlify/functions/auth-logout
...
export const handler = async (event, context) => {
  try {
    ...
    if (typeof fn !== 'function') {
      return { statusCode: 500, headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ success: false, error: 'Logout handler not available' }) };
    }
