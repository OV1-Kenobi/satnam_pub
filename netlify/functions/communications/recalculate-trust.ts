// Netlify Function adapter for /api/communications/recalculate-trust
...
export const handler = async (event: any) => {
  return new Promise((resolve) => {
    const req: any = {
      ...
      url: event.path || "/api/communications/recalculate-trust",
    ...
    (async () => {
      try {
        const { default: route } = await import("../../../api/communications/recalculate-trust.js");
