-- =====================================================
-- TRANSACTION-SAFE MIGRATION FOR REGISTER-IDENTITY
-- Fixes the "domain column does not exist" error by using proper transaction boundaries
-- =====================================================
...
-- Success notification (properly wrapped in DO block)
DO $$
BEGIN
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🎉 TRANSACTION-SAFE MIGRATION COMPLETED!';
    RAISE NOTICE '';
    ...
    IF table_count = 5 AND nip05_records_count >= 5 AND privacy_level_exists AND zero_knowledge_exists THEN
        RAISE NOTICE '🚀 SUCCESS: Ready for register-identity.js testing!';
        RAISE NOTICE '  • The "domain column" error has been resolved!';
