-- Clean Migration: Drop and Recreate with Unique Salts
-- WARNING: This deletes all existing data

DROP TABLE IF EXISTS family_memberships CASCADE;
DROP TABLE IF EXISTS privacy_sessions CASCADE;
DROP TABLE IF EXISTS encrypted_contacts CASCADE;
DROP TABLE IF EXISTS private_messages CASCADE;
DROP TABLE IF EXISTS privacy_users CASCADE;

DROP FUNCTION IF EXISTS set_current_user_hash(TEXT) CASCADE;

CREATE TABLE privacy_users (
    hashed_uuid TEXT PRIMARY KEY,
    user_identity_salt TEXT NOT NULL UNIQUE,
    auth_encryption_salt TEXT NOT NULL UNIQUE,
...
CREATE TABLE private_messages (
    ...
    content_encryption_salt TEXT NOT NULL UNIQUE,
    content_encryption_iv TEXT NOT NULL UNIQUE,
    ...
    key_derivation_salt TEXT NOT NULL UNIQUE,
...
CREATE TABLE encrypted_contacts (
    ...
    contact_encryption_salt TEXT NOT NULL UNIQUE,
    contact_encryption_iv TEXT NOT NULL UNIQUE,
...
CREATE TABLE privacy_sessions (
    ...
    session_encryption_salt TEXT NOT NULL UNIQUE,
    session_encryption_iv TEXT NOT NULL UNIQUE,
    key_derivation_salt TEXT NOT NULL UNIQUE,
...
CREATE TABLE family_memberships (
    ...
    federation_hash_salt TEXT NOT NULL UNIQUE,
